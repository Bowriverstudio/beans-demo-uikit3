...
$beans_sample_about_image_url = get_stylesheet_directory() . '/config/import/images/about.jpg';

return <<<CONTENT
<!-- wp:image {"id":2141,"align":"center"} -->
<div class="wp-block-image"><figure class="aligncenter"><img src="$beans_sample_about_image_url" alt="" class="wp-image-2141"/></figure></div>
<!-- /wp:image -->
