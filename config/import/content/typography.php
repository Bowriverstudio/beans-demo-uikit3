...
<div class="uk-grid">
	<div class="uk-width-1-1" data-uk-margin="">
		...
		<a href="https://getuikit.com/v2/docs/base.html " target="_blank">UiKit</a>
...
<div class="uk-grid" data-uk-grid-margin="">
		...
		<div class="uk-grid" data-uk-grid-margin="">
			<div class="uk-width-1-1 uk-row-first">
				<article class="uk-article">
					<div class="uk-grid" data-uk-grid-margin="">
						<div class="uk-width-1-2 uk-width-medium-1-3 uk-row-first">
			...
			<div class="uk-width-1-1 uk-grid-margin uk-row-first">
				<div class="uk-grid" data-uk-grid-margin="">
					...
					<div class="uk-width-small-1-2 uk-grid-margin uk-row-first">
				...
				<div class="uk-grid" data-uk-grid-margin="">
					...
					<div class="uk-width-small-1-2 uk-grid-margin uk-row-first">
						<ul class="uk-tab" data-uk-tab="">
							<li class="uk-tab-responsive uk-active" data-uk-dropdown="{mode:'click'}"
							    aria-haspopup="true" aria-expanded="false"><a>Active</a>
								<div class="uk-dropdown uk-dropdown-small uk-dropdown-bottom" aria-hidden="true"
								     style="top: 37px; left: 0px;" tabindex="">
									<ul class="uk-nav uk-nav-dropdown">
										<li class="uk-active"><a data-index="0" href="#">Active</a></li>
										<li class=""><a data-index="1" href="#">Item</a></li>
									</ul>
									<div></div>
								</div>
							</li>
	...
	<div class="uk-width-medium-1-2">
		...
		<div class="uk-grid" data-uk-grid-margin="">
			...
			<div class="uk-width-small-1-2 uk-form uk-grid-margin uk-row-first">
				<fieldset>
					...
					<div class="uk-form-row">
						<input type="text" placeholder="form-success" value="form-success"
						       class="uk-width-1-1 uk-form-success">
					</div>
					<div class="uk-form-row">
						<input type="text" placeholder="form-danger" value="form-danger"
